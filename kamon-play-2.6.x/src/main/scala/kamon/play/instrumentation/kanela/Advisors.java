...
public final class Advisors {
    ...
    static final class FilterMethodAdvisor {
        /**
         * Appends Kamon filter to {@link HttpFilters}.
         */
        @Advice.OnMethodExit
        public static void onFilters(@Advice.Return(readOnly = false) Seq<EssentialFilter> filters) {
